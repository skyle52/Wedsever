...
exports.userResetPassword = exports.sendResetPasswordEmail = exports.logoutRoute = exports.loginPostRoute = exports.loginRoute = void 0;
...
const ResetPassword_1 = require("../postgre/ResetPassword");
...
function loginPostRoute(app, session) {
    app.post("/login", async (req, res) => {
        const { username, password } = req.body;
        const isLoginValid = (0, postgre_1.isAdminLogin)(username, password, req.clientIp);
        isLoginValid.then(r => {
            (0, Admin_1.updateAdminLastLogin)().then(r1 => {
                if (r) {
                    session = req.session;
...
exports.loginPostRoute = loginPostRoute;
...
async function sendResetPasswordEmail(email) {
    ...
    const oAuth2Client = new googleapis_1.google.auth.OAuth2(CLIENT_ID, CLIENT_SECRET, REDIRECTED_URI);
    oAuth2Client.setCredentials({
        refresh_token: REFRESH_TOKEN
    });
    const _jwtToken = jsonwebtoken_1.default.sign({ email: email }, process.env.JWT_SECRET);
    try {
        ...
        return (0, postgre_1.createResult)("Một email đặt lại mật khẩu đã được gửi tới hòm thư của bạn, kiểm tra hòm thư và làm theo hướng dẫn!");
    }
    catch (e) {
        throw (0, postgre_1.createException)(e);
    }
}
...
async function userResetPassword(email) {
    try {
        ...
        return (0, postgre_1.createException)(e);
    }
}
